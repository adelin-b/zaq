defmodule Zaq.Channels.ChatBridge do
  ...
  # Pipeline status-stage updates have no surface on a blocking HTTP request
  # (the OpenAI wire has no side-channel for them): accept and drop, exactly
  # like the WebBridge fallback branch.
  @impl true
